...
\newcommand{\paraNumOFF}{
	\renewcommand{\theparagraph}{\thesection.\arabic{subsection} \alph{paragraph})}
} % aufzählung im paragraph mit 1.2 a). 1.2 b). und 1.2 c).

\newcommand{\paraNumON}{
	\renewcommand{\theparagraph}{\thesection.\arabic{subsection}.\arabic{paragraph}}
} % aufzählung bei paragraph mit 1.2.1 1.2.2 und 1.2.3
