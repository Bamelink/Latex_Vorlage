...
\newcommand{\myAuthor}{Jan Breuer, 7046 7578} 
\newcommand{\mySecondAuthor}{Mustafa Lali, 7046 8470} % Einfach leerlassen, wenn es keinen zweiten gibt
\newcommand{\myGroup}{Gruppe N23}
...
\begin{table}[H]
 ...
 % dazu kann man mit table-format = A.B die anzahl der erwarteten stellen eingeben dabei steht A für die Anzahl der zahlen vor dem komma und B fur die Anzahl hinter dem komma
    \begin{tabular}{|c|S[table-format = 2.14]|c|c|c|c|}
        \hline
        
        $I_A$                  & $R_L $ & $U_A$ & $\dfrac{\dd{u_A}}{\dd{t}}$ (Messung) & $\dfrac{\dd{u_A}}{\dd{t}}$ (Rechnung) & $I_{umlade}$ \\ \hline
        \SI{1}{\milli\ampere}  &  0,5505     &     \SI{1.7e3}{\g}  &                                      & \SI{100}{\volt\per\second}            &              \\ \hline
        \SI{5}{\milli\ampere}  &   0,55058545655    &       &                                      & \SI{500}{\volt\per\second}            &             \\ \hline
        \SI{10}{\milli\ampere} &   % \SI{0,550585}{\ohm}     
         &       &                                      & \SI{1000}{\volt\per\second}           &              \\ \hline
    \end{tabular}
\end{table}
