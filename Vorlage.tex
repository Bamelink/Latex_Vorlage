...
\include{./header/seiten_einstellungen}
\include{bitte_ausfuellen}
\include{./header/header} % header.tex ausgelagert, damit dies in Inkscape addon Tex Text genutzt werden kann
\include{bibtex_einstell}
