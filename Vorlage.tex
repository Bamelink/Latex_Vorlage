...
\newcommand{\myAuthor}{Max Mustermann, 70458112} 
\newcommand{\mySecondAuthor}{Max Musterfrau, 70458111} % Einfach leerlassen, wenn es keinen zweiten gibt
\newcommand{\myGroup}{Gruppe X-24}
\newcommand{\myTitle}{Versuch 1: Spannungsteiler}
...
\hypersetup{
    ...
    allcolors=ostfalia-blue % Farbe der Links einstellen
}
...
%\include{titlepage} % Optionale Titlepage und Sperrvermerk für Studienarbeit/Teamprojekt/BA...
...
\begin{figure}[H]
    ...
    \begin{tikzpicture}
        \begin{axis}[
                ...
                width=1.0\textwidth,
                height=0.4\textwidth]
            \addplot[color=blue] {1*x + 0.1*x^2 - 0.05*x^3};
        \end{axis}
    \end{tikzpicture}
